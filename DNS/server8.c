...
int main(int argc, char *argv[]){
	...
	addr_serv.sin_addr.s_addr = inet_addr("127.0.0.8");
	...
	while(1){ 
		...
		while(qNum>0){
			...
			char *filePath = NULL;
			switch(type){ 
				case A_TYPE: filePath = "8A.txt"; break;
				case CNAME_TYPE: filePath = "8CNAME.txt"; break;
				case MX_TYPE: filePath = "8MX.txt"; break;
				case PTR_TYPE: filePath = "8PTR.txt"; break;
			}
