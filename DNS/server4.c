...
int main(int argc, char *argv[]){
	...
	addr_serv.sin_addr.s_addr = inet_addr("127.0.0.4");
	...
	while(1){ 
		...
		while(qNum>0){
			...
			char *filePath = NULL;
			switch(type){ 
				case A_TYPE: filePath = "4A.txt"; break;
				case CNAME_TYPE: filePath = "4CNAME.txt"; break;
				case MX_TYPE: filePath = "4MX.txt"; break;
				case PTR_TYPE: filePath = "4PTR.txt"; break;
			}
